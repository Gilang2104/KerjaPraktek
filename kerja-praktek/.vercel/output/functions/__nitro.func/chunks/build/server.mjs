import { version, unref, inject, mergeProps, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, hasInjectionContext, getCurrentInstance, readonly, openBlock, createElementBlock, createElementVNode, renderSlot, createTextVNode, toDisplayString, resolveComponent, resolveDirective, withDirectives, createBlock, resolveDynamicComponent, withCtx, normalizeClass, createCommentVNode, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onMounted, onErrorCaptured, onServerPrefetch, createVNode, toRef, defineAsyncComponent, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, markRaw } from 'vue';
...
import { resolve, isNotEmpty, minifyCSS, toFlatCase, isFunction, getKeyValue, isString, isArray, isEmpty, isObject, toCapitalCase } from '@primeuix/utils/object';
import { findSingle, isClient, createElement, removeClass, getHeight, getWidth, getOuterWidth, getOuterHeight, getOffset, addClass, getAttribute, setAttributes, setAttribute, isExist } from '@primeuix/utils/dom';
...
function resolveUnrefHeadInput(ref2) {
  if (ref2 instanceof Promise || ref2 instanceof Date || ref2 instanceof RegExp)
    return ref2;
  const root4 = resolveUnref(ref2);
  if (!ref2 || !root4)
    return root4;
  if (Array.isArray(root4))
    return root4.map((r) => resolveUnrefHeadInput(r));
  if (typeof root4 === "object") {
    const resolved = {};
    for (const k in root4) {
      if (!Object.prototype.hasOwnProperty.call(root4, k)) {
        continue;
      }
      if (k === "titleTemplate" || k[0] === "o" && k[1] === "n") {
        resolved[k] = unref(root4[k]);
        continue;
      }
      resolved[k] = resolveUnrefHeadInput(root4[k]);
    }
    return resolved;
  }
  return root4;
...
const _routes = [
  {
    ...
    component: () => import('./FormPendaftaran-LXsGUH31.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BT2NeAQK.mjs')
  },
  {
    name: "Login",
    path: "/Login",
    component: () => import('./Login-BkB7WnuA.mjs')
  }
];
...
const primevue_plugin_egKpok8Auk = /* @__PURE__ */ defineNuxtPlugin(({ vueApp }) => {
  ...
  const pt = {};
  const theme9 = { theme: options == null ? void 0 : options.theme };
  usePrimeVue && vueApp.use(PrimeVue, { ...options, ...pt, ...theme9 });
...
var index = _objectSpread$3(_objectSpread$3({}, index$1k), {}, {
  components: {
    accordion: index$1o,
  ...
  computed: {
    ...
    $_attrsWithoutPT: function $_attrsWithoutPT() {
      return Object.entries(this.$attrs || {}).filter(function(_ref15) {
        var _ref16 = _slicedToArray$1(_ref15, 1), key = _ref16[0];
        return !(key !== null && key !== void 0 && key.startsWith("pt:"));
      }).reduce(function(acc, _ref17) {
        var _ref18 = _slicedToArray$1(_ref17, 2), key = _ref18[0], value = _ref18[1];
        acc[key] = value;
        return acc;
      }, {});
    }
...
var theme$2 = function theme5(_ref) {
  var dt2 = _ref.dt;
  return "\n.p-inputgroup,\n.p-inputgroup .p-floatlabel,\n.p-inputgroup .p-iftalabel {\n    display: flex;\n    align-items: stretch;\n    width: 100%;\n}\n\n.p-inputgroup .p-inputtext,\n.p-inputgroup .p-inputwrapper {\n    flex: 1 1 auto;\n    width: 1%;\n}\n\n.p-inputgroupaddon {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    padding: ".concat(dt2("inputgroup.addon.padding"), ";\n    background: ").concat(dt2("inputgroup.addon.background"), ";\n    color: ").concat(dt2("inputgroup.addon.color"), ";\n    border-top: 1px solid ").concat(dt2("inputgroup.addon.border.color"), ";\n    border-bottom: 1px solid ").concat(dt2("inputgroup.addon.border.color"), ";\n    min-width: ").concat(dt2("inputgroup.addon.min.width"), ";\n}\n\n.p-inputgroupaddon:first-child,\n.p-inputgroupaddon + .p-inputgroupaddon {\n    border-left: 1px solid ").concat(dt2("inputgroup.addon.border.color"), ";\n}\n\n.p-inputgroupaddon:last-child {\n    border-right: 1px solid ").concat(dt2("inputgroup.addon.border.color"), ";\n}\n\n.p-inputgroup > .p-component,\n.p-inputgroup > .p-inputwrapper > .p-component,\n.p-inputgroup > .p-floatlabel > .p-component,\n.p-inputgroup > .p-floatlabel > .p-inputwrapper > .p-component,\n.p-inputgroup > .p-iftalabel > .p-component,\n.p-inputgroup > .p-iftalabel > .p-inputwrapper > .p-component {\n    border-radius: 0;\n    margin: 0;\n}\n\n.p-inputgroupaddon:first-child,\n.p-inputgroup > .p-component:first-child,\n.p-inputgroup > .p-inputwrapper:first-child > .p-component,\n.p-inputgroup > .p-floatlabel:first-child > .p-component,\n.p-inputgroup > .p-floatlabel:first-child > .p-inputwrapper > .p-component,\n.p-inputgroup > .p-iftalabel:first-child > .p-component,\n.p-inputgroup > .p-iftalabel:first-child > .p-inputwrapper > .p-component {\n    border-top-left-radius: ").concat(dt2("inputgroup.addon.border.radius"), ";\n    border-bottom-left-radius: ").concat(dt2("inputgroup.addon.border.radius"), ";\n}\n\n.p-inputgroupaddon:last-child,\n.p-inputgroup > .p-component:last-child,\n.p-inputgroup > .p-inputwrapper:last-child > .p-component,\n.p-inputgroup > .p-floatlabel:last-child > .p-component,\n.p-inputgroup > .p-floatlabel:last-child > .p-inputwrapper > .p-component,\n.p-inputgroup > .p-iftalabel:last-child > .p-component,\n.p-inputgroup > .p-iftalabel:last-child > .p-inputwrapper > .p-component {\n    border-top-right-radius: ").concat(dt2("inputgroup.addon.border.radius"), ";\n    border-bottom-right-radius: ").concat(dt2("inputgroup.addon.border.radius"), ";\n}\n\n.p-inputgroup .p-component:focus,\n.p-inputgroup .p-component.p-focus,\n.p-inputgroup .p-inputwrapper-focus,\n.p-inputgroup .p-component:focus ~ label,\n.p-inputgroup .p-component.p-focus ~ label,\n.p-inputgroup .p-inputwrapper-focus ~ label {\n    z-index: 1;\n}\n\n.p-inputgroup > .p-button:not(.p-button-icon-only) {\n    width: auto;\n}\n");
};
var classes$2 = {
  root: "p-inputgroup"
};
...
const index_OL0QQUVtIF = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(PrimeVue, {
    theme: {
      preset: index
    }
  });
  nuxtApp.vueApp.component("Button", script$4);
  nuxtApp.vueApp.component("InputText", script$2);
  nuxtApp.vueApp.component("Toolbar", script);
  nuxtApp.vueApp.component("InputGroup", script$3);
});
const plugins = [
  unhead_KgADcZ0jPj,
  plugin,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cdc73HIJ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CTAe2Wc3.mjs'));
...
export { BaseStyle as B, Ripple as R, _export_sfc as _, script$8 as a, script$7 as b, script$4 as c, resolveRouteObject as d, entry$1 as default, navigateTo as e, useNuxtApp as f, useRuntimeConfig as g, script$3 as h, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, script$2 as s, useRouter as u };
